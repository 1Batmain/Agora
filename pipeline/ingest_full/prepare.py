...
def prepare(slug: str, *, raw_root: Path = RAW_DIR, out_dir: Path = OUT_DIR,
    ...
    """Matérialise JSONL canonique + descripteur pour `slug`. Rend un résumé."""
    ...
    descriptor = {
        ...
        "_note": f"Descripteur GÉNÉRÉ par pipeline.ingest_full.prepare depuis "
                 f"data/collect/raw/{slug}/ — ne pas éditer, régénérer.",
    }
    if label:

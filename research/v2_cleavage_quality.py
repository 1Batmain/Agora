...
Lancement (racine du worktree) :
  MISTRAL_API_KEY=$(cat /home/bat/projects/Analyse-des-consultations-citoyennes/var/mistral.key) \
...
KEY_FALLBACK = Path(
    "/home/bat/projects/Analyse-des-consultations-citoyennes/var/mistral.key")
